...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Syed Asghar Ali — Backend Developer" },
      {
        name: "description",
        content:
          "Backend developer building scalable REST APIs with Python, Django REST Framework and FastAPI.",
      },
      { name: "author", content: "Syed Asghar Ali" },
